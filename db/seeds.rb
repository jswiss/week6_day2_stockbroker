...
c1.client_stocks.create(stock_id: 1, stock_quantity: 100)
c1.client_stocks.create(stock_id: 2, stock_quantity: 70)
c2.client_stocks.create(stock_id: 7, stock_quantity: 12)
c2.client_stocks.create(stock_id: 8, stock_quantity: 1)
c3.client_stocks.create(stock_id: 5, stock_quantity: 45)
c3.client_stocks.create(stock_id: 4, stock_quantity: 2)
c4.client_stocks.create(stock_id: 4, stock_quantity: 23)
c5.client_stocks.create(stock_id: 6, stock_quantity: 1)
c6.client_stocks.create(stock_id: 2, stock_quantity: 32)
c6.client_stocks.create(stock_id: 6, stock_quantity: 459)
c6.client_stocks.create(stock_id: 3, stock_quantity: 44)
c7.client_stocks.create(stock_id: 8, stock_quantity: 232)
